...
use bevy::{utils::HashSet, color::palettes::css};
use bevy_rapier3d::{
    na::Isometry3,
    parry::{
...
impl<'c, 'f> GroundCastParams<'c, 'f> {
    ...
    pub fn cast_shape(
        ...
        gizmos.ray(self.position, self.direction * cast.toi, Color::from(css::BLUE));
        gizmos.sphere(
    ...
    pub fn sample_normals(
        ...
        gizmos.sphere(cast.point, Quat::IDENTITY, valid_radius, Color::from(css::RED)); // Bounding sphere of valid ray normals
